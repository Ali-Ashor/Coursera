...
<body bgcolor="chocoloty">
	...
	<div align="right">
	    ...
	    <h2>INTRODUCTION</h2>
	<p>Karakorum Paradise Public Public School is a public sector in which both boys and girls can enhance their knowledge. Schooling provided between the class of nursery to tenth. Affiliated with FBISE (Federal Board Of Intermediate Secondory Education). </p>
	    <br><br><br><br>
	</div>
	<p>    
